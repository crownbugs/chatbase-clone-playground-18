...
const IntegrationHub = () => {
  ...
  const [chatbotId] = useState('cb_abc123def456');
  const [domain] = useState('www.chatbase.co');
...
<script
  src="${window.location.origin}/embed.min.js"
  chatbotId="${chatbotId}"
  domain="${window.location.origin}"
  defer>
</script>`;
  ...
  src="${window.location.origin}/chat/${chatbotId}"
  width="100%"
  height="600"
  frameborder="0">
</iframe>`;

  const apiExample = `// Initialize Chatbase API
...
// Send a message
const response = await chatbase.sendMessage({
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex gap-2">
                    <Input value={chatbotId} readOnly />
                    <Button variant="outline" size="icon" onClick={() => copyToClipboard(chatbotId)}>
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                <span className="text-muted-foreground">Today's Conversations</span>
                <Badge>147</Badge>
              </div>
              <div className="flex justify-between">
